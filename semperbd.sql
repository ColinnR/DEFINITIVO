...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2022 a las 13:58:20
...
(16, 'diegoo', 'skulltrap2002@gmail.com', '$2y$10$BAgDiNuGuwxONCpcC5si6eJYkH5Fe0HKwbju37x/EP4iKfRPrOgI6', 'default.png', '61903e7b762dae637a7808f1d237ce17', 0),
(17, 'Ulises', 'colinrojasdiegoulises@gmail.com', '$2y$10$lbYoSoaZxMoCHpdfAtR03eN593rWN94Oo2FmAeRcBbbnKlGWDTr8m', 'default.png', '3cb3745d42debd38c47edae2450a17dc', 0);
...
(21, 'Juice - Orange, Concentrate', 'Excision of Right Zygomatic Bone, Percutaneous Endoscopic Approach, Diagnostic', '268.02', 23, 'https://robohash.org/eligendiprovidentvoluptatem.png?size=800x800&set=set1', 1),
(22, 'Gatorade - Lemon Lime', 'Excision of Cervical Vertebral Joint, Percutaneous Approach, Diagnostic', '320.53', 31080, 'https://robohash.org/quivoluptassunt.png?size=800x800&set=set1', 2),
(23, 'Roe - Flying Fish', 'Plain Radiography of Bilateral Temporomandibular Joints using High Osmolar Contrast', '535.57', 78, 'https://robohash.org/ullamdoloripsa.png?size=800x800&set=set1', 3),
(24, 'Beets', 'Excision of Perineum Muscle, Percutaneous Endoscopic Approach, Diagnostic', '869.09', 1950, 'https://robohash.org/eiuseteos.png?size=800x800&set=set1', 4),
(25, 'Nut - Hazelnut, Ground, Natural', 'Bypass Pancreatic Duct to Small Intestine, Percutaneous Endoscopic Approach', '406.20', 0, 'https://robohash.org/laudantiumdoloresipsum.png?size=800x800&set=set1', 5),
(26, 'Chocolate - Milk Coating', 'Excision of Sacrococcygeal Joint, Percutaneous Endoscopic Approach', '953.66', 782, 'https://robohash.org/quicommodiasperiores.png?size=800x800&set=set1', 6);
